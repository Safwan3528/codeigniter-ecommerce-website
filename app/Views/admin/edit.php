            ...
            <?php echo form_open_multipart('/gambar/edit/' . $gambar['id'] ) ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="3"><?= $gambar['keterangan'] ?></textarea>
                  ...
                  <div class="form-group row">
                    ...
                    <img src="/img/<?= $gambar['nama_fail'];?>" alt="" style="max-width: 300px;" class="img-fluid">
